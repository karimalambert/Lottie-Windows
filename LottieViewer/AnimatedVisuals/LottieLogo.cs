...
//       Version: 6.1.0-build.73+g6174bfba36
//
    ...
    sealed class LottieLogo : Microsoft.UI.Xaml.Controls.IAnimatedVisualSource
    {
        ...
        sealed class AnimatedVisual : Microsoft.UI.Xaml.Controls.IAnimatedVisual
        {
            ...
            Vector2KeyFrameAnimation OffsetVector2Animation_07()
            {
                ...
                result.InsertExpressionKeyFrame(0.245810062F, "(Pow(1-_.t3,3)*Vector2(-250.583,-258.947))+(3*Square(1-_.t3)*_.t3*Vector2(-250.583,-258.947))+(3*(1-_.t3)*Square(_.t3)*Vector2(-249.6143,-337.5837))+(Pow(_.t3,3)*Vector2(-230.458,-339.322))", _stepThenHoldEasingFunction);
                result.InsertExpressionKeyFrame(0.301675975F, "(Pow(1-_.t3,3)*Vector2(-230.458,-339.322))+(3*Square(1-_.t3)*_.t3*Vector2(-214.2505,-340.7927))+(3*(1-_.t3)*Square(_.t3)*Vector2(-210.958,-164.322))+(Pow(_.t3,3)*Vector2(-210.958,-164.322))", _stepThenHoldEasingFunction);
            ...
            Vector2KeyFrameAnimation OffsetVector2Animation_08()
            {
                ...
                result.InsertKeyFrame(0.17318435F, new Vector2(-259.583008F, -193.447006F), _holdThenStepEasingFunction);
                result.InsertKeyFrame(0.196966484F, new Vector2(-250.582993F, -258.946991F), _cubicBezierEasingFunction_02);
                result.InsertExpressionKeyFrame(0.245810062F, "(Pow(1-_.t4,3)*Vector2(-250.583,-258.947))+(3*Square(1-_.t4)*_.t4*Vector2(-250.583,-258.947))+(3*(1-_.t4)*Square(_.t4)*Vector2(-249.6143,-337.5837))+(Pow(_.t4,3)*Vector2(-230.458,-339.322))", _stepThenHoldEasingFunction);
                result.InsertExpressionKeyFrame(0.301675975F, "(Pow(1-_.t4,3)*Vector2(-230.458,-339.322))+(3*Square(1-_.t4)*_.t4*Vector2(-214.2505,-340.7927))+(3*(1-_.t4)*Square(_.t4)*Vector2(-210.958,-164.322))+(Pow(_.t4,3)*Vector2(-210.958,-164.322))", _stepThenHoldEasingFunction);
                result.InsertKeyFrame(0.301676005F, new Vector2(-210.957993F, -164.322006F), _stepThenHoldEasingFunction);
            ...
            ContainerVisual Root()
            {
                ...
                StartProgressBoundAnimation(result, "t3", _scalarAnimation_0_to_1, _rootProgress);
                StartProgressBoundAnimation(result, "t4", _scalarAnimation_0_to_1, _rootProgress);
                return result;
            }
            ...
            CompositionSpriteShape SpriteShape_00()
            {
                ...
                var result = CreateSpriteShape(RoundedRectangle_375x667(), new Matrix3x2(1F, 0F, 0F, 1F, 187.5F, 333.5F), ColorBrush_AlmostDarkTurquoise_FF00D1C1());
                return result;
            }
            ...
            {
                // Translate:<196, 267>
                var result = CreateSpriteShape(Ellipse_4p6(), new Matrix3x2(1F, 0F, 0F, 1F, 196F, 267F), ColorBrush_White());
                return result;
            }
            ...
            {
                // Translate:<196, 267>
                var result = CreateSpriteShape(Ellipse_4p7(), new Matrix3x2(1F, 0F, 0F, 1F, 196F, 267F), _colorBrush_White);
                return result;
            }
            ...
            {
                // Translate:<196, 267>
                var result = CreateSpriteShape(_ellipse_4p7, new Matrix3x2(1F, 0F, 0F, 1F, 196F, 267F), _colorBrush_White);
                return result;
            }
