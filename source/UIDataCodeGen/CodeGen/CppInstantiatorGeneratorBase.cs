...
namespace Microsoft.Toolkit.Uwp.UI.Lottie.UIData.CodeGen
{
    ...
    abstract class CppInstantiatorGeneratorBase : InstantiatorGeneratorBase
    {
        ...
        protected string GenerateHeaderText()
        {
            ...
            if (SourceInfo.Interface.NormalizedQualifiedName != "Microsoft.UI.Xaml.Controls.IAnimatedVisual")
            {
        ...
        protected override void WriteFileStart(CodeBuilder builder)
        {
            ...
            if (SourceInfo.Interface is null)
            {
                namespaces.Add(Muxc);
            }
        ...
        void WriteHeaderNamespaceStart(CodeBuilder builder, string inherits)
        {
            ...
            if (_isCppWinrtMode)
            {
                builder.WriteLine($"class {SourceClassName}");
                builder.Indent();
                builder.WriteLine($": public winrt::implements<{SourceClassName}, winrt::{inherits}>");
                builder.UnIndent();
            }
            else
            {
            ...
            if (SourceInfo.IsThemed)
            {
                WritePrivateThemeHeader(builder);
            }
        ...
        {
            var interfaceName = SourceInfo.Interface == null;

            if (SourceInfo.GenerateDependencyObject)
            {
                WriteHeaderNamespaceStart(builder, $"Windows::UI::Xaml::DependencyObject, {AnimatedVisualTypeName}Source");
            }
            else
            {
                WriteHeaderNamespaceStart(builder, $"{AnimatedVisualTypeName}Source");
            }
        ...
        void WriteIDynamicAnimatedVisualSourceHeaderText(CodeBuilder builder)
        {
            ...
            WriteHeaderNamespaceStart(builder, "public IDynamicAnimatedVisualSource, INotifyPropertyChanged");
            ...
            builder.WriteLine();
            builder.WriteLine($"virtual {_s.ReferenceTypeName($"{S.Hatted(AnimatedVisualTypeName)}")} TryCreateAnimatedVisual(");
            builder.Indent();
            builder.WriteLine($"{Wuc}::{_typeName.Compositor} compositor,");
            builder.WriteLine($"{_typeName.Object}* diagnostics);");
            builder.UnIndent();
            ...
            builder.Indent();
            builder.WriteLine($"const int c_loadedImageSurfaceCount = {SourceInfo.LoadedImageSurfaces.Distinct().Count()};");
