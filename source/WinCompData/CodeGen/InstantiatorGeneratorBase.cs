    ...
    abstract class InstantiatorGeneratorBase
    {
            ...
            float height)
        {
            ...
            var info = new CodeGenInfo(
                ...
                requiresWin2d: _nodes.Where(n => n.RequiresWin2D).Any(), // Determine whether to add #includes and usings for namespaces.
        ...
        protected sealed class CodeGenInfo
        {
            ...
            /// <summary>
            /// Gets a value indicating  whether the composition depends on Win2D or D2D functionality.
            /// </summary>
